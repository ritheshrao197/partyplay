# Loki - Multiplayer Party Game Platform

Loki is a real-time multiplayer party game platform where users can create rooms, invite friends, and play various social games together. The platform is built using a modern TypeScript stack, featuring a React frontend and a Node.js/Express backend, with Socket.IO for real-time communication.
